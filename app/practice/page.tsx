...
const hskCards = [
  ...
  {
    href: "/practice/listening?module=hsk",
    icon: "flame" as const,
    accent: "bg-sky-600",
  ...
  {
    href: "/practice/reading?module=hsk",
    icon: "book" as const,
...
const englishCards = [
  {
    href: "/practice/listening?module=english",
    icon: "flame" as const,
    accent: "bg-sky-600",
    titleKey: "listen.title",
    descKey: "listen.subtitle",
  ...
  {
    href: "/practice/grammar?module=english",
    icon: "pen" as const,
    accent: "bg-amber-600",
    titleKey: "grammar.title",
    descKey: "grammar.subtitle",
  },
  {
    href: "/mock-test?module=english",
    icon: "chart" as const,
    accent: "bg-teal-600",
    titleKey: "practice.takeTest",
    descKey: "practice.takeTestDesc",
...
const otherCards = [
  {
    href: "/mock-test?module=japanese",
    icon: "chart" as const,
    accent: "bg-teal-600",
    titleKey: "practice.takeTest",
    descKey: "practice.takeTestDesc",
...
function cardsFor(moduleId: string) {
  if (moduleId === "hsk") return hskCards;
  if (moduleId === "english") return englishCards;
  return otherCards;
}
...
export default async function PracticePage({
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Latihan per modul: HSK punya susun kalimat, mendengarkan & membaca;
          English punya mendengarkan & grammar; modul lain cukup mock test. */}
      <section className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        {cardsFor(languageModule.id).map((card) => (
          <Link
            key={card.href}
            href={card.href}
